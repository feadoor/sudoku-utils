...
fn main() {
    ...
    let template = Template::from_str(&"\
        ...
        .....X.1.\
        ...8X....\
    ".replace("A", "[12]").replace("B", "[34]").replace("X", "[5678]").replace("Y", "[123456789]"));
    let pipeline = Pipeline {
        base: GenerationBase::Template(template),
        steps: vec![
            PipelineStep::Expansion(Expansion::plus_n(2, DihedralSubgroup::DiagonalUrToDlSymm, "r1c1,r2c1,r3c1,r4c1,r7c1,r8c1,r9c1,r1c6,r2c6,r3c6,r4c6,r5c6,r6c6,r9c6,r4c4,r4c5,r4c7,r4c8,r4c9,r9c2,r9c3,r9c7,r9c8,r9c9")),
